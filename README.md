...
This project uses Machine Learning ( KNeighborsClassification) to predict whether a user will purchase a product based on social network advertisement data.
...
from sklearn.neighbors import KNeighborsClassification->Use: Imports the  KNeighborsClassification to build the prediction model.
